...
namespace nesemu
{
	...
	void CPU::opcode_jmp()
	{
		mProgramCounter = GMemory->ReadMemoryAddress(mCurrentOperandAddress);
	}
...
{\
	...
	void CPU::RegisterOpcodes()
	{
		...
		SET_OPCODE(0x92, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0x93, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0x97, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0x9A, "TXS", &CPU::opcode_notimplemented, AddressingMode::Implied, 2);
		SET_OPCODE(0x9B, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0x9C, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0x9D, "STA", &CPU::opcode_sta, AddressingMode::AbsoluteX, 5);
		SET_OPCODE(0x9E, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0x9F, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xA3, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xA7, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xAB, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xAF, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xB2, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xB3, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xB7, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xBA, "TSX", &CPU::opcode_notimplemented, AddressingMode::Implied, 2);
		SET_OPCODE(0xBB, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xBF, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);

		SET_OPCODE(0xC0, "CPY", &CPU::opcode_notimplemented, AddressingMode::Immediate, 2);
		SET_OPCODE(0xC1, "CMP", &CPU::opcode_notimplemented, AddressingMode::IndirectX, 6);
		SET_OPCODE(0xC2, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xC3, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xC4, "CPY", &CPU::opcode_notimplemented, AddressingMode::ZeroPage, 3);
		SET_OPCODE(0xC5, "CMP", &CPU::opcode_notimplemented, AddressingMode::ZeroPage, 3);
		SET_OPCODE(0xC6, "DEC", &CPU::opcode_notimplemented, AddressingMode::ZeroPage, 5);
		SET_OPCODE(0xC7, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xC8, "INY", &CPU::opcode_notimplemented, AddressingMode::Implied, 2);
		SET_OPCODE(0xC9, "CMP", &CPU::opcode_notimplemented, AddressingMode::Immediate, 2);
		SET_OPCODE(0xCA, "DEX", &CPU::opcode_notimplemented, AddressingMode::Implied, 2);
		SET_OPCODE(0xCB, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xCC, "CPY", &CPU::opcode_notimplemented, AddressingMode::Absolute, 4);
		SET_OPCODE(0xCD, "CMP", &CPU::opcode_notimplemented, AddressingMode::Absolute, 4);
		SET_OPCODE(0xCE, "DEC", &CPU::opcode_notimplemented, AddressingMode::Absolute, 6);
		SET_OPCODE(0xCF, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);

		SET_OPCODE(0xD0, "BNE", &CPU::opcode_bne, AddressingMode::Immediate, 2); // TODO: add cycles if branch is taken
		SET_OPCODE(0xD1, "CMP", &CPU::opcode_notimplemented, AddressingMode::IndirectY, 5);
		SET_OPCODE(0xD2, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xD3, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xD4, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xD5, "CMP", &CPU::opcode_notimplemented, AddressingMode::ZeroPageX, 4);
		SET_OPCODE(0xD6, "DEC", &CPU::opcode_notimplemented, AddressingMode::ZeroPageX, 6);
		SET_OPCODE(0xD7, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xD8, "CLD", &CPU::opcode_cld, AddressingMode::Implied, 2);
		SET_OPCODE(0xD9, "CMP", &CPU::opcode_notimplemented, AddressingMode::AbsoluteY, 4);
		SET_OPCODE(0xDA, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xDB, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xDC, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xDD, "CMP", &CPU::opcode_notimplemented, AddressingMode::AbsoluteX, 4);
		SET_OPCODE(0xDE, "DEC", &CPU::opcode_notimplemented, AddressingMode::AbsoluteX, 7);
		SET_OPCODE(0xDF, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xE2, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xE3, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xE7, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xEB, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xEF, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xF2, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xF3, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xF4, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xF7, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xFA, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xFB, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		SET_OPCODE(0xFC, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
		...
		SET_OPCODE(0xFF, "", &CPU::opcode_notimplemented, AddressingMode::Implied, 0);
